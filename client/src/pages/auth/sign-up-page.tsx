        ...
        <section className="max-w-7xl mx-auto flex items-center justify-center min-h-screen">
            <form onSubmit={submitHandler} className="w-1/2 border border-gray-200 rounded-md p-6">
                ...
                <div>
                    ...
                    <Input placeholder="john doe" name="fullname" value={inputs.fullname} onChange={changeEventHandler} />
                </div>
                <div>
                    <Label>Email</Label>
                ...
                <div>
                    ...
                    <Input placeholder="+91 1234567899" name="phoneNumber" value={inputs.phoneNumber} onChange={changeEventHandler} />
                </div>
                <div>
